...
// @@protoc_insertion_point(message:Identity)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Identity {
    // message fields
    // @@protoc_insertion_point(field:Identity.protocolVersion)
    pub protocolVersion: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:Identity.agentVersion)
    pub agentVersion: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:Identity.publicKey)
    pub publicKey: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:Identity.listenAddrs)
    pub listenAddrs: ::std::vec::Vec<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:Identity.observedAddr)
    pub observedAddr: ::std::option::Option<::std::vec::Vec<u8>>,
    // @@protoc_insertion_point(field:Identity.protocols)
    pub protocols: ::std::vec::Vec<::std::string::String>,
    // @@protoc_insertion_point(field:Identity.signedPeerRecord)
    pub signedPeerRecord: ::std::option::Option<::std::vec::Vec<u8>>,
    // special fields
    // @@protoc_insertion_point(special_field:Identity.special_fields)
